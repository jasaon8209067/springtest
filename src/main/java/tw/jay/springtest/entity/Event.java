...
public class Event {
    ...
    private LocalDateTime sales_start;//LocalDateTime 也不帶時區 → 適合表示單純的“當地時間”。
    ...
    public LocalDateTime getSales_start() {
        return sales_start;
    }

    public void setSales_start(LocalDateTime sales_start) {
